 ...
 * 公众号：Hadoop实操
 */
public class MyFirstCoprocessorEndPoint extends com.cloudera.hbase.coprocessor.server.MyFirstCoprocessor.AggregationService implements Coprocessor, CoprocessorService {
    protected static final Log log = LogFactory.getLog(MyFirstCoprocessorEndPoint.class);

    private RegionCoprocessorEnvironment env;

    @Override
    public void getAggregation(RpcController controller, com.cloudera.hbase.coprocessor.server.MyFirstCoprocessor.MyCoprocessRequest request, RpcCallback<com.cloudera.hbase.coprocessor.server.MyFirstCoprocessor.MyCoprocessResponse> done) {
        Scan scan = new Scan();
        ...
        com.cloudera.hbase.coprocessor.server.MyFirstCoprocessor.MyCoprocessResponse response = null;
        Double max = null;
        Double min = null;
        Double sumVal = null;
        long counter = 0L;
        ...
        try {
            ...
            response = com.cloudera.hbase.coprocessor.server.MyFirstCoprocessor.MyCoprocessResponse.newBuilder()
